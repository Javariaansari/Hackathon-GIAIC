...
export default function SignUp() {
  return (
    <div className="bg-third text-black">
     ...
     <div className="relative font-[sans-serif] before:absolute before:w-full before:h-full before:inset-0 before:bg-black before:opacity-50 before:z-10">
       ...
       Signup Page
         ...
         <div className="flex items-center space-x-2 text-white">
           ...
           <a href="/about" className="text-orange-500">Signup</a>
         </div>
       </div>
     </div>
        ...
        <div className="container mx-auto max-w-md bg-white shadow-lg rounded-md p-8">
          ...
          <div className="text-center mt-8">
            ...
            <button className="w-full bg-gray-100 border text-black py-2 rounded mt-2 flex gap-[78px] items-center justify-center">
              <Image src="/image/google.svg" alt="Google" className="h-6 mr-2" width={20} height={20}/>
              Sign up with Google
            </button>
            <button className="w-full bg-gray-100 border text-black py-2 rounded mt-2 gap-[78px] flex items-center justify-center">
              <Image src="/image/Apple.svg" alt="Apple" className="h-6 mr-2 " width={20} height={20} />
              Sign up with Apple
            </button>
          </div>
        </div>
