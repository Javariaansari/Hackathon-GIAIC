...
const ShoppingCart: React.FC = () => {
  ...
  return (
    <div className="bg-primary font-sans text-primary">
        <Header/>
      <header className="bg-cover bg-center h-80 flex items-center justify-center" style={{ backgroundImage: "url('/image/header.svg')" }}>
            ...
            {cartItems.map((item, index) => (
              <tr key={index} className="border-b">
                <td className="p-4 flex items-center">
                  <img src="/image/shooping1.svg" alt="shopping" className="w-16 h-16 object-cover rounded mr-4" />
                  <span>{item.name}</span>
                </td>
